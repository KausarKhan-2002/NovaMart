...
function TagsModal({ nextType, cancelSwitch, confirmTagTypeSwitch }) {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-6 md:px-0">
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
        ...
        <div className="flex justify-end gap-3">
          <button
            ...
            className="px-4 py-2 bg-gray-200 text-gray-800 dark:text-white rounded-md"
          >
            Cancel
          </button>
          <button
